...
# 
# These exercises are designed to be done anytime after Tutorial #5c (animations and meshes)
...
# 
# If we haven't gotten to features and spots quite yet, you can read [this spots tutorial](http://phoebe-project.org/docs/latest/tutorials/spots) to get the basics.
# 
# Hints:
