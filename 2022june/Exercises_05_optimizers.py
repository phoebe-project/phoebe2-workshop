...
# 
# Try to find a decent fit to the observations by running **optimizers** from the results from **estimators**.  Later, we'll use the optimized solution as a starting point for MCMC - so try to get the residuals as flat as possible and make sure to save your progress.
# 
