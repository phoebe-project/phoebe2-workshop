...
# # Exercises #7: Optimizers
# 
# These exercises are designed to be done any time after the tutorial on optimizers.
# 
# Try to find a decent fit to the observations by running **optimizers** on top of the results obtained from the **estimators**.  Later, we will use the optimized solution as a starting point for the sampler (MCMC) - so try to get the residuals as flat as possible and make sure to save your progress.
# 
# * [lc.B.data](https://github.com/phoebe-project/phoebe2-workshop/raw/2022june/data/dataset_exercises/lc.B.data) (times, fluxes, sigmas - Johnson B passband)
# * [lc.V.data](https://github.com/phoebe-project/phoebe2-workshop/raw/2022june/data/dataset_exercises/lc.V.data) (times, fluxes, sigmas - Johnson V passband)
# * [rv1.data](https://github.com/phoebe-project/phoebe2-workshop/raw/2022june/data/dataset_exercises/rv1.data) (times, rvs, sigmas for primary star)
# * [rv2.data](https://github.com/phoebe-project/phoebe2-workshop/raw/2022june/data/dataset_exercises/rv2.data) (times, rvs, sigmas for secondary star - same times as `rv1.data`, so feel free to merge into a single PHOEBE dataset)
# 
# 
...
# 
# For optimization runs, feel free to submit the jobs remotely and make use of `progress_every_niters` and `b.load_job_progress`.  Once you get somewhat close to a good solution, make sure to determine if any of the expensive effects can safely be disabled (see [optimizing computations](./Tutorial_11_optimizing_computations.ipynb) from the first week) before adding a bunch of extra free parameters or running for extended iterations overnight.  For any approximations you do take, make sure to re-evaluate their validity as you go!
